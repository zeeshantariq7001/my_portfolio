...
List<Project> demo_projects = [
  ...
  Project(
    title: "Task Reminder System - Flutter complete app",
    description:
        "A complete app in which we can get notified about our daily basis and scheduled tasks and a notepad as well.",
  ),
  Project(
    title: "Tenor Gif App - Flutter app with attractive UI",
    description:
        "In very first version of this app we use Tenor Gif API and used a search box to search the required gifs and can share to others.",
  ),
  Project(
